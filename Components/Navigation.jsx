...
const Navigation = () => {
    ...
    let { isLogged } = useContext(AuthenticationContext);
        ...
        <div className="w-full">
            ...
            <nav className="flex items-center w-full justify-between flex-wrap p-3">
                <div className="flex items-center flex-shrink-0 mr-6">
                    <img className="h-8 w-8 rounded-full" width="40" height="40" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt=""/>
                </div>
